...
<head>
  <title>Library Management System|| Old Books</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Add Old Books </h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page"> Add Old Books</li>
              </ol>
            </nav>
          </div>
            ...
            <div class="table-horizontal-container">
              <table class="unfixed-table" id="mytable">
                ...
                <tbody>
                  ...
                  <?php $user_query = mysqli_query($conn, "select * from tblbook where status = 'old'") or die();
