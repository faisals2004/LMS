...
<head>
  ...
  <title>Library Management System|| New Books</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Add New Books </h3>
            ...
            <div class="table-horizontal-container">
              <table class="unfixed-table" id="mytable">
                ...
                <tbody>
                  ...
                  <?php $user_query = mysqli_query($conn, "select * from tblbook where status = 'new'") or die();
