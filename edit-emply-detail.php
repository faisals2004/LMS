...
$sql="update tblemployee set EmployeeName=:ename,Designation=:designation where ID=:eid";
...
<html lang="en">
  <head>
    ...
    <title>Library  Management System|| Manage Employee</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Manage Employee</h4>
...
{               ?>  
                      <div class="form-group">
                        ...
                        <input type="text" name="ename" value="<?php  echo htmlentities($row->EmployeeName);?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Designation</label>
                        <select  name="designation" class="form-control" required='true'>
                          <option value="<?php  echo htmlentities($row->Section);?>"><?php  echo htmlentities($row->Designation);?></option>
