...
<head>
  ...
  <title>Library Management System|| Damage</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Add Damage Books </h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page"> Add Damage Books</li>
              </ol>
            </nav>
          </div>
            ...
            <div class="table-horizontal-container">
              <table class="unfixed-table" id="mytable">
                ...
                <body>
                  ...
                  <?php $user_query = mysqli_query($conn, "select * from tblbook where status = 'Damage'") or die();
